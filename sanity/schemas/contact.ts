    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: 'cardHeading',
          type: 'string',
          title: 'Contact Info Card Heading',
          description: 'Heading for the contact info card (e.g., "Contact Information")',
          fieldset: 'marketingCopy',
        ...
        },
        {
          ...
          type: 'string',
          title: 'Address Label',
          description: 'Label above address (e.g., "Headquarters")',
          fieldset: 'marketingCopy',
        ...
        },
        {
          ...
          type: 'string',
          title: 'Email Label',
          description: 'Label above email address (e.g., "Email")',
          fieldset: 'marketingCopy',
          initialValue: 'Email',
        },
        {
          ...
          type: 'string',
          title: 'Hours Label',
          description: 'Label above business hours (e.g., "Business Hours")',
          fieldset: 'marketingCopy',
        ...
        },
        {
          ...
          type: 'string',
          title: 'Form Heading',
          description: 'Heading for the contact form (e.g., "Request a Quote")',
          fieldset: 'marketingCopy',
        ...
        },
        {
          name: 'mapHeading',
          type: 'string',
          title: 'Map/Facility Heading',
          description: 'Heading on the location card (e.g., "Visit Our Facility")',
          fieldset: 'marketingCopy',
          initialValue: 'Visit Our Facility',
        },
        {
          name: 'interestOptions',
          type: 'array',
          title: 'Interest Options',
          description: 'Options for the "Interest" dropdown on the contact form',
          fieldset: 'marketingCopy',
          of: [
            {
              type: 'object',
        ...
        },
        {
          ...
          description: 'Options for the "Timeline" dropdown on the contact form',
          fieldset: 'marketingCopy',
          of: [
            {
              type: 'object',
