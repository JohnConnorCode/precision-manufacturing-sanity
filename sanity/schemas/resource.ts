export default {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'boolean',
      title: 'Published',
      description: 'Controls whether this resource appears on the website. Toggle off to hide without deleting.',
      group: 'general',
      initialValue: true,
    },
    {
      ...
      type: 'text',
      title: 'Excerpt',
      description: 'Brief excerpt for cards and previews (100-200 characters)',
      group: 'general',
      rows: 3,
    ...
    },
    {
      ...
      type: 'string',
      title: 'Category',
      description: 'Resource category for organization (e.g., "material-science", "quality-compliance")',
      group: 'metadata',
      fieldset: 'categoryInfo',
      validation: (Rule: any) => Rule.required().error('Category is required for organization'),
      options: {
        list: [
          {title: 'Machining Processes', value: 'manufacturing-processes'},
