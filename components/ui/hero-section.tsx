...
interface HeroSectionProps {
  // Image Configuration (optional - for text-only heroes)
...
export default function HeroSection({
  ...
  // Professional B2B font sizes - properly scaled for readability
    ...
    >
      ...
      {showScrollIndicator && (
        <motion.div
          ...
          animate={isMounted ? { opacity: 1 } : (prefersReducedMotion ? { opacity: 1 } : { opacity: 0 })}
